...
let myaccount = algosdk.mnemonicToSecretKey(
  "average domain solid squirrel roast merge ticket wrist matrix erode cherry segment audit cupboard chapter spirit crime blossom banana debate bread sure lunch absent notable");
...
(async () => {
  try {
    ...
    const receiver =
      "IK7MDSCW3TIH2OKP7AJJCAKS7DZURSGAIGE4VNY6ICDAXSDUKKKORHLSAM";
